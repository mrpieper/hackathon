...
namespace DeviceOne
{
    ...
    class Device
    {
        ...
        static string iotHubUri = "team53hub.azure-devices.net";
        static string deviceKey = "XV6aKxdEGL37YnNLeOTs7S1C5dc6Qhmzfn1m3kJexaQ=";
        static string deviceName = "team53device3";
