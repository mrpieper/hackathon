...
namespace IOT
{
    ...
    class Caller
    {
        ...
        static string connectionString = "HostName=team53hub.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=12etMNgrmbfgnajvf3HDccTVWrjSmOZmX7U/BI+Icp4=";
        ...
        static void Main(string[] args)
        {
            ...
            payload.deviceName = "team53device3";
